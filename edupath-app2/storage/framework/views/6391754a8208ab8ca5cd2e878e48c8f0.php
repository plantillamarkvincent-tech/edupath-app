...
<head>
    ...
    <title>SPF - <?php echo e($enrollmentRequest->full_name); ?></title>
<style>
    @page {
        size: A4;
        margin: 0.5in;
...
<div class="spf-form">
    <!-- Header -->
    <?php echo $__env->make('admin.enrollment_requests._spf_header', ['enrollmentRequest' => $enrollmentRequest ?? null, 'pageNo' => '1 of 2'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div style="position: relative; margin-bottom: 15px; min-height: 150px;">
        ...
        <div class="photo-box" id="photoBox" style="float: right; margin: 0; position: relative;">
            <?php if(!empty($enrollmentRequest->student_photo)): ?>
                <img src="<?php echo e(asset('storage/' . $enrollmentRequest->student_photo)); ?>" 
                     alt="Student Photo" 
    ...
    <div id="spfForm">
        ...
        <div class="section page-break" style="margin-top: 40px;">
            ...
            <div style="margin-bottom: 20px;">
                <?php echo $__env->make('admin.enrollment_requests._spf_header', ['enrollmentRequest' => $enrollmentRequest ?? null, 'pageNo' => '2 of 2'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
...
<script>
    ...
    const enrollmentData = <?php echo json_encode($enrollmentRequest, 15, 512) ?>;
...
<?php /**PATH C:\Users\Admin\edupath-app\edupath-app2\resources\views/admin/enrollment_requests/spf_view.blade.php ENDPATH**/ ?>