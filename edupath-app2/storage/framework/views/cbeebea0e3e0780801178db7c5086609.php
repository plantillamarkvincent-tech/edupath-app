...
<?php if($logoPath): ?>
    <img src="<?php echo e(asset($logoPath)); ?>" alt="Baganga campus" <?php echo e($attributes->merge(['class' => 'w-8 h-7 mx-auto object-contain'])); ?> />
<?php else: ?>
    <div <?php echo e($attributes->merge(['class' => 'w-8 h-7 mx-auto flex items-center justify-center bg-gray-20 text-gray-60 rounded-full'])); ?>>Logo</div>
<?php endif; ?>
<?php /**PATH C:\Users\Admin\edupath-app\edupath-app2\resources\views/components/application-logo.blade.php ENDPATH**/ ?>