...
<div class="container mx-auto px-4 sm:px-6 pb-6">
	...
	<div class="mb-3 sm:mb-4 flex items-center justify-between gap-3 flex-wrap">
		<div>
			...
			<p class="text-xs text-gray-500 mt-0.5"><?php echo e($programs->count()); ?> program<?php echo e($programs->count() !== 1 ? 's' : ''); ?> available</p>
		</div>
		<?php if(auth()->guard()->check()): ?>
			<?php if(Auth::user()->isAdmin()): ?>
				<a href="<?php echo e(route('admin.programs.create')); ?>" class="btn-add-program px-3 py-1.5 transition shadow-sm hover:shadow text-xs sm:text-sm font-semibold">
					+ Add Program
				</a>
			<?php endif; ?>
		<?php endif; ?>
	...
	<div class="program-grid">
		<?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<div class="program-card">
				...
				<p><?php echo e(Str::limit($program->description, 130)); ?></p>
                <div class="card-actions mt-auto">
                    <a href="<?php echo e(route('career.show', $program)); ?>" class="btn-career btn-primary">View</a>
                    <a href="<?php echo e(route('enrollment.create', $program)); ?>" class="btn-career btn-success">Enroll</a>
				</div>
			</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\edupath-app\edupath-app2\resources\views/career/index.blade.php ENDPATH**/ ?>