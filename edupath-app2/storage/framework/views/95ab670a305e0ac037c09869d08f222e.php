...
<head>
    ...
    <style>
        ...
        .landing-hero::before {
            ...
            bottom: 0;
            <?php if($bgLogo): ?>
            background-image: url('<?php echo e($bgLogo); ?>');
...
<body class="font-sans antialiased">
    <div class="landing-hero">
        <div class="landing-content">
            ...
            <div class="nav-links">
                <a href="<?php echo e(route('career.index')); ?>" class="nav-button">Click View </a>
            </div>
        </div>
    </div>
</body>
...
<?php /**PATH C:\Users\Admin\edupath-app\edupath-app2\resources\views/landing.blade.php ENDPATH**/ ?>