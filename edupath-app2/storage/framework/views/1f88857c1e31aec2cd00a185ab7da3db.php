        ...
        <?php if(isset($deletedRequests) && $deletedRequests->count() > 0): ?>
            <table class="min-w-full">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    <?php $__currentLoopData = $deletedRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                            <td class="px-6 py-4 text-sm"><?php echo e($req->id); ?></td>
                            <td class="px-6 py-4 text-sm"><?php echo e($req->full_name); ?></td>
                            <td class="px-6 py-4 text-sm"><?php echo e(optional($req->program)->name); ?></td>
                            <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-400"><?php echo e(optional($req->deleted_at)->format('M d, Y h:i A')); ?></td>
                            <td class="px-6 py-4 text-right">
                                <div class="inline-flex items-center gap-2">
                                    <form method="POST" action="<?php echo e(route('admin.enrollment_requests.restore', $req->id)); ?>">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <form method="POST" action="<?php echo e(route('admin.enrollment_requests.force_delete', $req->id)); ?>" onsubmit="return confirm('Permanently delete this request? This cannot be undone.');">
                                        <?php echo csrf_field(); ?>
            ...
            <div class="p-4"><?php echo e($deletedRequests->links()); ?></div>
        <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\edupath-app\edupath-app2\resources\views/admin/backup/index.blade.php ENDPATH**/ ?>